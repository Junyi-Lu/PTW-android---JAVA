...
public class WatchedListAcceptanceTest {
    @Rule
    ...
    public void testAddAndDelete() {
        ...
        //add The Shawshank Redemption to Watched
        movieEntry = onData(anything()).inAdapterView(withId(R.id.watching_list_view)).atPosition(0);
        movieEntry.onChildView((withId(R.id.movie_add))).perform(click());

        //add The Godfather to Watched
        movieEntry.onChildView((withId(R.id.movie_add))).perform(click());

        //add The Godfather: Part 2 to Watched
        movieEntry.onChildView((withId(R.id.movie_add))).perform(click());
        ...
        onView(withId(R.id.watched_list_view)).check(matches(hasDescendant(withText(containsString("The Shawshank Redemption")))));
        onView(withId(R.id.watched_list_view)).check(matches(hasDescendant(withText(containsString("The Godfather")))));
        onView(withId(R.id.watched_list_view)).check(matches(hasDescendant(withText(containsString("The Godfather: Part II")))));
        ...
        onView(withId(R.id.watched_list_view)).check(matches(not(hasDescendant(withText(containsString("The Shawshank Redemption (1994)"))))));

        //check if The Godfather and The Godfather: Part II are still in the list
        onView(withId(R.id.watched_list_view)).check(matches(hasDescendant(withText(containsString("The Godfather (1972)")))));
        onView(withId(R.id.watched_list_view)).check(matches(hasDescendant(withText(containsString("The Godfather: Part II (1974)")))));
        ...
        onView(withId(R.id.watched_list_view)).check(matches(not(hasDescendant(withText(containsString("The Godfather (1972)"))))));
        ...
        onView(withId(R.id.watched_list_view)).check(matches(not(hasDescendant(withText(containsString("The Godfather: Part II (1974)"))))));
    }
    ...
    public void testSearch() {
        ...
        onView(withId(R.id.watched_list_view)).check(matches(not(hasDescendant(withText(containsString("The Shawshank Redemption"))))));
        onView(withId(R.id.watched_list_view)).check(matches(not(hasDescendant(withText(containsString("Fargo"))))));
